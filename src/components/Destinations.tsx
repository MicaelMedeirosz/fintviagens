    ...
    >
      ...
      <div className="relative p-8 h-full flex flex-col">
        <div className="flex items-start justify-between mb-4">
          <div>
            <p className="text-xs text-white/50 uppercase tracking-wider mb-1">Destino</p>
        ...
        <div className="flex-1 flex flex-col justify-end">
          ...
          <div className="pt-6 border-t border-white/10">
            <div className="relative mb-1">
              <p className={`text-3xl font-bold font-display text-sky transition-all duration-500 ${revealed ? '' : 'blur-[8px] text-transparent bg-clip-text bg-gradient-to-r from-white/20 to-white/5'}`}>
                {dest.price}
              </p>
              {!revealed && (
                <motion.div
            ...
            <p className="text-sm text-white/50">ida e volta • taxes incluídas</p>
            <p className={`text-sm text-white/40 mt-1 transition-all duration-500 ${revealed ? '' : 'blur-[4px]'}`}>
              ≈ {installment}
            </p>
          </div>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          ...
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight mb-4">
            Destinos mais <span className="text-sky">procurados</span>
          </h2>
          <p className="text-lg text-white/60">
            Voos diretos e conexões das principais cidades suíças para o mundo todo.
          </p>
        </motion.div>
        ...
        >
          <motion.a
            ...
            whileTap={{ scale: 0.98 }}
          >
            Ver todos os 100+ destinos pelo mundo
