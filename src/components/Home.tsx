...
import ApprovalPopup, { ApprovalPopupHandle } from './ApprovalPopup'
...
export default function Home() {
   ...
   const approvalRef = useRef<ApprovalPopupHandle>(null)
  ...
  return (
   ...
   }} onApprovalClick={() => approvalRef.current?.open()} />
      <TrustBar />
      <HowItWorks />
      <Destinations />
      <Features />
